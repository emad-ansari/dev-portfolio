...
import fitness from "@/assets/app-fitness.png";
import learnify from "@/assets/app-learnify.png";
import grocify from "@/assets/app-grocify.png";
...
const projects = [
	{
		...
		tag: "Workout Tracker",
		year: "2025",
		blurb: "A cross-platform workout tracking app to plan, track, and analyze fitness activities in real time. Sanity CMS powers the exercise library, Clerk handles auth, and Reanimated drives the UI motion.",
		stack: [
			"React Native",
			"Expo",
			"Zustand",
		...
		image: fitness,
		link: "https://github.com/emad-ansari/workout-tracker",
	...
	},
	{
		...
		year: "2025",
		blurb: "A high-performance grocery management app to organize shopping lists and streamline planning. Drizzle ORM with Neon Postgres on the backend, Clerk auth, and smooth Reanimated transitions on the frontend.",
		stack: [
			"React Native",
			"Expo",
			"Drizzle ORM",
		...
		image: grocify,
		link: "https://github.com/emad-ansari/Grocify",
		accent: "oklch(0.55 0.025 240)",
	},
	{
		n: "03",
		title: "Learnify",
		tag: "E-Learning Mobile App",
		year: "2026",
		blurb: "A modern e-learning mobile application built with React Native and Expo, featuring smooth animations, course discovery, category filters, authentication, profile management, bookmark support, skeleton loaders, and optimized FlatList performance for a premium learning experience.",
		stack: [
			"React Native",
			"Expo",
			"TypeScript",
		...
		image: learnify,
		link: "https://github.com/emad-ansari/learnify",
