  ...
  return (
    <section id="contact" className="px-6 md:px-10 pt-28 md:pt-40 pb-12 bg-primary text-primary-foreground relative overflow-hidden">
      <div className="mx-auto max-w-[1400px]">
        ...
        >
          Open to my first <br />
          <span className="italic text-primary-foreground/70">full-time role.</span>
        </motion.h2>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-12 gap-10 items-end">
          ...
          <div className="md:col-span-4 md:col-start-9 space-y-3 text-sm text-primary-foreground/70">
            <div className="flex justify-between border-b border-primary-foreground/20 pb-2">
              <span>Location</span><span>Greater Noida, India</span>
            </div>
            <div className="flex justify-between border-b border-primary-foreground/20 pb-2">
              <span>Phone</span><span>+91 8416886921</span>
            </div>
            <div className="flex justify-between border-b border-primary-foreground/20 pb-2">
              <span>Status</span><span>Open to opportunities</span>
            </div>
          </div>
        </div>
        ...
        <footer className="mt-32 pt-8 border-t border-primary-foreground/20 flex flex-wrap items-center justify-between gap-4 text-xs font-mono text-primary-foreground/60">
          ...
          <div className="flex gap-6">
            <a href="https://github.com/emad-ansari" target="_blank" rel="noreferrer" className="hover:text-primary-foreground">GitHub</a>
            <a href="https://leetcode.com/u/emad-ansari/" target="_blank" rel="noreferrer" className="hover:text-primary-foreground">LeetCode</a>
            <a href="https://linkedin.com/in/mohammad-emad-ab4688304/" target="_blank" rel="noreferrer" className="hover:text-primary-foreground">LinkedIn</a>
          </div>
        </footer>
      </div>
    </section>
